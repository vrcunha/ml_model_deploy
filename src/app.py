...
# subtítulo
st.markdown("Data App utilizado para exibir a solução de Machine Learning para o problema de predição de valores alugueis de imóveis.")
st.markdown("Modificado por Victor Cunha.")
